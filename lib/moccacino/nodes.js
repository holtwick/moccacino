(function() {
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compileNode = function(o) {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (node instanceof Block) {
          ...
          node.front = true;
          code = node.compile(o);
          codes.push(node.isStatement(o) ? code : "" + this.tab + code + "; // End");
        } else {
          codes.push(node.compile(o, LEVEL_LIST));
        }
      }
      if (top) return codes.join('\n');
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      ...
      if (scope.expressions === this) {
        ...
        if (declars && !o.level === LEVEL_TOP) {
          code += "" + this.tab + "id " + (scope.declaredVariables().join(', ')) + "; // Declarations\n";
        }
        if (assigns && !o.level === LEVEL_TOP) {
          code += "" + this.tab + "id " + (multident(scope.assignedVariables().join(', '), this.tab)) + "; // Assingnments\n";
        }
      }
      return code + post;
    };
  ...
  exports.Index = Index = (function() {
    ...
    Index.prototype.compile = function(o) {
      return " objectAtIndex:" + (this.index.compile(o, LEVEL_PAREN));
    };
  ...
  exports.Range = Range = (function() {
    ...
    Range.prototype.compileArray = function(o) {
      ...
      if (this.fromNum && this.toNum) {
        ...
        body = "id " + vars + "; " + cond + " ? " + i + " <" + this.equals + " " + this.toVar + " : " + i + " >" + this.equals + " " + this.toVar + "; " + cond + " ? " + i + "++ : " + i + "--";
      }
      post = "{ " + result + ".push(" + i + "); }\n" + idt + "return " + result + ";\n" + o.indent;
  ...
  exports.Class = Class = (function() {
    ...
    Class.prototype.ensureConstructor = function(name) {
      if (!this.ctor) this.ctor = new Code;
    ...
    Class.prototype.compileNode = function(o) {
      ...
      return "@@implementation " + name + (this.parent ? " : " + this.parent.compile(o) : void 0) + "\n " + (klass.compile(o)) + " \n@end\n";
    };
    return Class;
  })();
